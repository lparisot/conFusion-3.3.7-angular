...
angular.module('confusionApp')
  ...
  .factory('favoriteFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    return $resource(baseURL + "favorites/:id", null, {'update': {method: 'PUT'}, 'query': {method:'GET', isArray: false}});
  }])
  ...
  .factory('AuthFactory', ['$resource', '$http', '$localStorage', '$rootScope', '$window', 'baseURL', 'ngDialog',
    function($resource, $http, $localStorage, $rootScope, $window, baseURL, ngDialog) {
      ...
      function destroyUserCredentials() {
        ...
        $http.defaults.headers.common['x-access-token'] = authToken = undefined;
